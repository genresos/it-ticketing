...
const ModalDetailsIssue = ({ visible, onClose, data, onReopen }: Props) => {
  const {
    id,
    requestor,
    title,
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Stack direction={{ base: "column", md: "row" }}>
            ...
            <Box flex={1}>
              ...
              <ListDetails
                label="Finish in Hour"
                value={`${finish_in_hour} Hour`}
              />
            </Box>
          </Stack>
        ...
        <ModalFooter>
          <Button
            ...
            onClick={onReopen}
            disabled={status_id !== "Closed" ? true : false}
          >
            Reopen Issue
          </Button>
        </ModalFooter>
...
export default ModalDetailsIssue;
